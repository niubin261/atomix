...
public class WebSocketRegisterRequest extends RegisterRequest implements WebSocketRequest<WebSocketRegisterRequest> {
  ...
  public static class Builder extends RegisterRequest.Builder {
    ...
    public RegisterRequest copy(RegisterRequest request) {
      return new io.atomix.copycat.protocol.websocket.request.WebSocketRegisterRequest(id, request.client(), request.timeout());
    }

    @Override
    public RegisterRequest build() {
      return new io.atomix.copycat.protocol.websocket.request.WebSocketRegisterRequest(id, client, timeout);
    }
  }
}
