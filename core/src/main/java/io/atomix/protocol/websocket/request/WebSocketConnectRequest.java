...
public class WebSocketConnectRequest extends ConnectRequest implements WebSocketRequest<WebSocketConnectRequest> {
  ...
  public static class Builder extends ConnectRequest.Builder {
    ...
    public ConnectRequest copy(ConnectRequest request) {
      return new io.atomix.copycat.protocol.websocket.request.WebSocketConnectRequest(id, request.client());
    }

    @Override
    public ConnectRequest build() {
      return new io.atomix.copycat.protocol.websocket.request.WebSocketConnectRequest(id, client);
    }
  }
}
