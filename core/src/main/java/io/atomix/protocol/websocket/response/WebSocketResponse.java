...
public interface WebSocketResponse<T extends WebSocketResponse<T>> extends ProtocolResponse {
   ...
   */
  interface Builder<T extends Builder<T, U>, U extends io.atomix.copycat.protocol.websocket.response.WebSocketResponse> extends ProtocolResponse.Builder<T, U> {
    /**
