 ...
 */
package io.atomix.protocol.http.handlers;
 ...
 */
public class CreateSessionHandler extends io.atomix.copycat.protocol.http.handlers.RequestHandler {

  /**
   * Create session request handler factory.
   */
  public static class Factory implements io.atomix.copycat.protocol.http.handlers.RequestHandler.Factory {
    @Override
    public RequestHandler create(HttpServerConnection connection) {
      return new io.atomix.copycat.protocol.http.handlers.CreateSessionHandler(connection);
    }
  }
