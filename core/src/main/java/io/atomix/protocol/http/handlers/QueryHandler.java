 ...
 */
public class QueryHandler extends io.atomix.copycat.protocol.http.handlers.RequestHandler {
  ...
  public static class Factory implements io.atomix.copycat.protocol.http.handlers.RequestHandler.Factory {
    ...
    public RequestHandler create(HttpServerConnection connection) {
      return new io.atomix.copycat.protocol.http.handlers.QueryHandler(connection);
    }
  }
